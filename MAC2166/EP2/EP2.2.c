    ...
    while(opcao != 6){
        ...
        if(opcao == 1 || opcao == 2){
            ...
            if(num1 != 0 && num2 != 0){
                ...
                /* Aumenta o expoente até -99, se possível */
         if(TESTE){       while(dignum1 > 1 && exp1 < -99){
                    num1 /= 10;
                    exp1++;
                    dignum1--; }
                }
                /* Underflow se o numero ainda for menor que 1E-99 */
        ...
        if(opcao == 3){
            ...
            while(dignum2 >= 1 && !(Overflow||Underflow)){
                ...
                /* - Checagem de Underflow - */
                /* Aumenta o expoente até -99, se possível */
       /*    if(TESTE){     while(dignumS > 1 && expS < -99){
                    numS /= 10;
                    expS++;
                    dignumS--; }
                } */
                ...
                /* PARA TESTES/ */
                if(TESTE){
                    /* if(expS < 0){sinalS == NEG; expS *= (-1);} */
                    printf("//Operando S = %dE%d e ", numS, expS);
                    printf("Numero de digitos: %d\n", dignumS);
                }
            }
        ...
        if(opcao == 4){
            ...
            if(num2 == 0){
                ...
                /* PARA TESTES */
                if(TESTE){
                    /* if(expD < 0){sinalD == NEG; expD *= (-1);} */
                    printf("\n//Operando D = %dE%d e ", numD, expD);
                    printf("Numero de digitos: %d\n", dignumD);
                }
          ...
          /* if(TESTE){     while(dignum1 > 1 && exp1 < -99){
                ...
                /* PARA TESTES */
                if(TESTE){
                    printf("//Operando 1 = %dE%d e ", num1, exp1);
                    printf("Numero de digitos: %d\n", dignum1);
                }
